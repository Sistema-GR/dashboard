<template>
    <Whiteboard title="Editar Recurso" :isSidebarMinimized="isSidebarMinimized">
        ...
        <div class="flex flex-col w-full px-4">
            ...
            <p class="font-medium text-15 text-justify mb-8 mt-4">
            ...
            <p class="font-bold text-15 mb-5 text-justify pb-1">
                ...
                <p class="text-lg font-bold mb-4">Dados do Servidor</p>
                    <div class="space-y-2">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <p class="font-semibold text-15 mb-1">CPF:</p>
                            <p class="text-gray-600 text-15">123.456.789-00</p>
                        </div>

                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <p class="font-semibold text-15 mb-1">Email:</p>
                            <p class="text-gray-600 text-15">example@domain.com</p>
                        </div>

                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <p class="font-semibold text-15 mb-1">Cargo:</p>
                            <p class="text-gray-600 text-15">Desenvolvedor</p>
                        </div>

                         <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <p class="font-semibold text-15 mb-1">Unidade:</p>
                            <p class="text-gray-600 text-15">TI</p>
                        </div>
            ...
            <div class="flex flex-col border-t-2 py-1">
                ...
                <div class="flex flex-col border-b-2 py-5">
                    ...
                    <textarea v-model="description"class="w-full border rounded-md p-2 text-15" rows="4" placeholder="Descreva o motivo do recurso aqui..." :class="{ 'border-red-500': descriptionError }" @input="validateDescription" />
                ...
                <div class="flex flex-col border-b-2 py-4 gap-1">
                    <label class="font-semibold text-15 mb-1">Documentos Anexados</label>
                    <input type="file" @change="handleFileUpload" multiple  class="block w-full text-15 text-gray-500 file:mr-4 file:py-2 file:px-4 file:border file:border-gray-300 file:rounded-[10px] file:text-15 file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"/>

                    <div v-if="files.length > 0" class="mt-4">
                        <h3 class="font-semibold text-15 mb-2">Arquivos Anexados:</h3>
                        <div class="flex flex-col space-y-2">
                            <div v-for="(file, index) in files" :key="index" class="flex items-center justify-between border p-2 rounded-[10px] bg-blue-50 border-blue-500 text-blue-700">
                ...
                <RouterLink to="sucess" class="flex w-full justify-end mt-6 space-x-4">
                    <PrimaryButton customColor="bg-blue-500 text-15 w-6/12 md:w-3/12" value="Salvar" :disabled="isSaving" @click="saveChanges" />
                </RouterLink>
