<template>
    <Whiteboard title="Recursos Reabertos" class="-translate-y-20" :isSidebarMinimized="isSidebarMinimized" :hideBreadcrumbs="true">
      <div class="flex flex-col w-full 4 gap-10 lg:flex-row">
            ...
            <div class="flex-1 px-2 border rounded-lg shadow-lg">
                ...
                <div class="flex items-center justify-between border-b-2 m-3">
                    <p class="text-xl font-semibold my-2">Reaberto</p>
