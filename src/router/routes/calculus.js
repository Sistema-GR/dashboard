...
export default [
    { path: '/calculus', name: 'calculus', meta: { public: false, requiresAuth: true, roles: ['admin', 'staff'] },
      children: [
        ...
        { path: 'create', name: 'create', meta: { requiresAdmin: true },
          children: [
        ...
        { path: 'versionmanager/:id?', name: 'versionmanager', props: true, meta: { requiresAdmin: true },
          children: [
        ...
        { path: 'alloc', name: 'alloc', component: () => import('@/views/Admin/AllocCalc/index.vue'), meta: { requiresAdmin: true } }, //to be deleted
        { path: 'previousresults', name: 'previousresults', component: () => import('@/views/Admin/PreviousResults/index.vue'), meta: { requiresAdmin: true } },
        { path: 'dataversions', name: 'dataversions', component: () => import('@/views/Admin/DataDversions/index.vue'), meta: { requiresAdmin: true } },
